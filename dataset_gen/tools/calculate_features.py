...
class FeatureCalculator():
    ...
    def init(self, thread_count, code_section_minimum_size, limit_number_of_binaries, downloaded_architectures, full_binaries, random_sampling, sample_size, input_path, output_path):
